...
- **API Base:** `/api/v1/` with REST endpoints
- **Auth:** Spring Security + OAuth2 (GitHub OAuth App + GitHub App)
- **Async:** DeferredResult + ThreadPoolTaskExecutor for AI-heavy endpoints
...
|--------|------|------|-------------|
| POST | /api/v1/portfolio/generate | Public | Generate portfolio from GitHub username |
| GET | /api/v1/portfolio | Public | List portfolios |
| GET | /api/v1/portfolio/{id} | Public | Get portfolio by ID |
| POST | /api/v1/repos/analyze | Public | Analyze individual repo |
| GET | /api/v1/repos/analyses | Public | List analyses |
| GET | /api/v1/repos/analyses/{id} | Public | Get analysis by ID |
| POST | /api/v1/repos/readme/commit | OAuth | Commit README to repo |

### Frontend (Planned)
- React 19+ or Next.js 15+ with TypeScript
- Tailwind CSS for styling
- Backend API at `serviceportfolioapi.pablohgdev.com` (prod) / `serviceportfolioapi-dev.pablohgdev.com` (dev)
